...
/**
 * @notice Fuzz tests for the function "_calculateTotalShare" of contract "LiquidatorL1".
 */
contract CalculateTotalShare_LiquidatorL1_Fuzz_Test is LiquidatorL1_Fuzz_Test {
    /* ///////////////////////////////////////////////////////////////
                              SETUP
    /////////////////////////////////////////////////////////////// */
    ...
    function testFuzz_Success_calculateTotalShare(
        ...
        uint32[] memory assetShares = liquidator_.getAssetShares(assetValues_);
        ...
        uint256 actualTotalShare = liquidator_.calculateTotalShare(account_, askedAssetAmounts);
