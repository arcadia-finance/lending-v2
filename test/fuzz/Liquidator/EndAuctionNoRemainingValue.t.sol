...
contract EndAuctionNoRemainingValue_Liquidator_Fuzz_Test is Liquidator_Fuzz_Test {
    ...
    function testFuzz_Success_EndAuctionNoRemainingValue(
        ...
        startPriceMultiplier = uint16(bound(startPriceMultiplier, 10_100, 30_000));
        vm.assume(minPriceMultiplier < 91);
        amountLoaned = bound(amountLoaned, 1, 1000); // As we can't set to oracle to return0, we need to be left with dust amount to test.
        ...
        // Set price of stable1 to 1, as this should leave a dust value.
