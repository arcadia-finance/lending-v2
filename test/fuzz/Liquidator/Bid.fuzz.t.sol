...
contract Bid_Liquidator_Fuzz_Test is Liquidator_Fuzz_Test {
    ...
    function testFuzz_Revert_bid_SequencerDown(address bidder, uint112 amountLoaned, uint32 startedAt) public {
        ...
        liquidator.bid(address(proxyAccount), new uint256[](2), false);
    }
    ...
    function testFuzz_Success_bid_SequencerUpDuringAuction(
        address bidder,
    ...
    function testFuzz_Success_bid_SequencerDownDuringAuction(
        address bidder,
        uint112 amountLoaned,
        uint32 liquidationStartTime,
        uint32 sequencerStartedAt
