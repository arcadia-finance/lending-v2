...
library InterestRateParameters {
    ...
    uint72 internal constant LOW_SLOPE_CBBTC = 0 * 1e16; // -> APY goes from 4% to 4% for utilisation of 0 to 80%
    uint72 internal constant HIGH_SLOPE_CBBTC = 500 * 1e16; // -> APY goes from 4% to 104% for utilisation of 80 to 100%
    ...
    uint72 internal constant HIGH_SLOPE_USDC = 500 * 1e16; // -> APY goes from 8% to 108% for utilisation of 80 to 100%
    ...
    uint72 internal constant HIGH_SLOPE_WETH = 500 * 1e16; // -> APY goes from 6% to 106% for utilisation of 80 to 100%
